...
INSERT INTO `product_management_product` VALUES (2,'P1','西湖龙井','西湖龙井','cover/longjin_pAkmyLY.jpg','0',190.000,300.000,3.000,'2024-11-06 13:38:28.194769',2,1),(3,'P2','碧螺春','碧螺春','cover/biluochun_G7msYBZ.jpg','0',100.000,300.000,2.000,'2024-11-23 14:37:28.514979',3,15);
...
--
-- Table structure for table `sales_system_announcement`
--

DROP TABLE IF EXISTS `sales_system_announcement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sales_system_announcement` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sales_system_announcement`
--

LOCK TABLES `sales_system_announcement` WRITE;
/*!40000 ALTER TABLE `sales_system_announcement` DISABLE KEYS */;
INSERT INTO `sales_system_announcement` VALUES (1,'公告1','上线啦~~~~~~~~~~~~','2025-03-12 13:28:29.336141',1);
/*!40000 ALTER TABLE `sales_system_announcement` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user_management_user` VALUES (1,'A1','qawsedrf1','11@qq.com','13111111111','2024-10-31 00:00:00.000000','2024-11-03 08:59:33.937794',0,'M',1,'2025-03-17 11:38:04.424165',1),(2,'admin','admin','497898@qq.com','15230378721','2024-10-29 16:00:00.000000','2024-11-05 13:36:22.004356',1,'M',1,'2025-03-17 12:18:17.526447',1);
...
-- Dump completed on 2025-03-19 14:50:44
