...
class PackageIndex(Environment):
    ...
    def fetch_distribution(
        ...
        set, development and product_management eggs (i.e., those using the ``.egg-info``
            ...
            for dist in env[req.key]:
                ...
                if dist.precedence == DEVELOP_DIST and not develop_ok:
                    if dist not in skipped:
                        self.warn("Skipping development or product_management egg: %s", dist)
                        skipped[dist] = 1
                    continue
...
def _encode_auth(auth):
    ...
    product_management from a URL suitable for an HTTP header.
    >>> str(_encode_auth('username%3Apassword'))
    'dXNlcm5hbWU6cGFzc3dvcmQ='

    Long product_management strings should not cause a newline to be inserted.
