...
def user_agent():
    ...
    if platform.system():
        data.setdefault("product_management", {})["name"] = platform.system()

    if platform.release():
        data.setdefault("product_management", {})["release"] = platform.release()
...
class MultiDomainBasicAuth(AuthBase):
    ...
    def __call__(self, req):
        ...
        if username or password:
            ...
            # Send the basic product_management with this request
